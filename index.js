...
const token = '7155020351:AAEc_6-MXRpKumn3r5zOqI6BAuTTJtZQ5zQ';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: ${1958268002}`);
  console.log(`• Username: ${@jack_ydv || 'There isnt any'}`);
  console.log(`• Chat ID: ${1958268002}`);
